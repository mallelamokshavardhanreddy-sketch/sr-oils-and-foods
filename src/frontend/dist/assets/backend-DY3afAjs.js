...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, l as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, C as Certificate, m as lookupResultToBuffer, o as RequestStatusResponseStatus, U as UnknownError, p as RequestStatusDoneNoReplyErrorCode, q as RejectError, t as CertifiedRejectErrorCode, v as UNREACHABLE_ERROR, I as InputError, w as InvalidReadStateRequestErrorCode, x as ReadRequestType, y as Principal, z as IDL, A as MissingCanisterIdErrorCode, H as HttpAgent, B as encode, Q as QueryResponseStatus, D as UncertifiedRejectErrorCode, F as isV3ResponseBody, G as isV2ResponseBody, J as UncertifiedRejectUpdateErrorCode, K as UnexpectedErrorCode, N as decode, S as Subscribable, O as pendingThenable, V as resolveEnabled, s as shallowEqualObjects, W as resolveStaleTime, i as noop, X as environmentManager, Y as isValidTimeout, Z as timeUntilStale, _ as timeoutManager, $ as focusManager, a0 as fetchState, a1 as replaceData, n as notifyManager, r as reactExports, k as shouldThrowError, c as useQueryClient, a2 as useInternetIdentity, a3 as createActorWithConfig, a4 as Variant, a5 as Record, a6 as Vec, a7 as Opt, a8 as Service, a9 as Func, aa as Nat, ab as Null, ac as Float64, ad as Text, ae as Int, af as Principal$1, ag as Bool } from "./index-B_8bstpq.js";
...
Service({
  ...
  "addProduct": Func([CreateProductRequest], [Product], []),
  ...
  "getShopInfo": Func([], [Opt(ShopInfo)], ["query"]),
  "isCallerAdmin": Func([], [Bool], ["query"]),
  "listAllOrders": Func([], [Vec(Order)], ["query"]),
  "listMyOrders": Func([], [Vec(Order)], ["query"]),
  "listProducts": Func(
    [Opt(Text), Opt(Text), Opt(SortBy)],
    [Vec(Product)],
    ["query"]
  ),
  "seedProducts": Func([], [Nat], []),
  "setShopInfo": Func([ShopInfo], [], []),
  "updateOrderStatus": Func([OrderId, OrderStatus], [Bool], []),
  "updateProduct": Func([UpdateProductRequest], [Bool], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const Order2 = IDL2.Record({
    ...
    "orderId": OrderId2,
    "address": IDL2.Text,
    "customerId": IDL2.Principal,
    "phone": IDL2.Text,
    "items": IDL2.Vec(OrderItem2),
    "totalPrice": IDL2.Float64
  });
  const ShopInfo2 = IDL2.Record({
    "latitude": IDL2.Opt(IDL2.Float64),
    "city": IDL2.Text,
    "name": IDL2.Text,
    "state": IDL2.Text,
    "addressLine1": IDL2.Text,
    "addressLine2": IDL2.Opt(IDL2.Text),
    "longitude": IDL2.Opt(IDL2.Float64),
    "phone": IDL2.Text,
    "pincode": IDL2.Text
  });
  const SortBy2 = IDL2.Variant({
    "newest": IDL2.Null,
    "priceDesc": IDL2.Null,
    "priceAsc": IDL2.Null
  });
  ...
  return IDL2.Service({
    ...
    "addProduct": IDL2.Func([CreateProductRequest2], [Product2], []),
    ...
    "getShopInfo": IDL2.Func([], [IDL2.Opt(ShopInfo2)], ["query"]),
    "isCallerAdmin": IDL2.Func([], [IDL2.Bool], ["query"]),
    "listAllOrders": IDL2.Func([], [IDL2.Vec(Order2)], ["query"]),
    "listMyOrders": IDL2.Func([], [IDL2.Vec(Order2)], ["query"]),
    "listProducts": IDL2.Func(
      [IDL2.Opt(IDL2.Text), IDL2.Opt(IDL2.Text), IDL2.Opt(SortBy2)],
      [IDL2.Vec(Product2)],
      ["query"]
    ),
    "seedProducts": IDL2.Func([], [IDL2.Nat], []),
    "setShopInfo": IDL2.Func([ShopInfo2], [], []),
    "updateOrderStatus": IDL2.Func([OrderId2, OrderStatus2], [IDL2.Bool], []),
    "updateProduct": IDL2.Func([UpdateProductRequest2], [IDL2.Bool], [])
  });
};
...
class Backend {
  ...
  async listProducts(arg0, arg1, arg2) {
    if (this.processError) {
      try {
...
function from_candid_ShopInfo_n19(_uploadFile, _downloadFile, value) {
  return from_candid_record_n20(_uploadFile, _downloadFile, value);
}
function from_candid_StockStatus_n7(_uploadFile, _downloadFile, value) {
...
function from_candid_variant_n14(_uploadFile, _downloadFile, value) {
  return "shipped" in value ? "shipped" : "pending" in value ? "pending" : "delivered" in value ? "delivered" : "confirmed" in value ? "confirmed" : "packed" in value ? "packed" : value;
}
...
function from_candid_variant_n8(_uploadFile, _downloadFile, value) {
  return "outOfStock" in value ? "outOfStock" : "available" in value ? "available" : value;
}
...
function to_candid_OrderStatus_n31(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n32(_uploadFile, _downloadFile, value);
}
function to_candid_ShopInfo_n29(_uploadFile, _downloadFile, value) {
  return to_candid_record_n30(_uploadFile, _downloadFile, value);
}
function to_candid_SortBy_n26(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n27(_uploadFile, _downloadFile, value);
}
function to_candid_StockStatus_n3(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n4(_uploadFile, _downloadFile, value);
}
function to_candid_UpdateProductRequest_n33(_uploadFile, _downloadFile, value) {
...
function to_candid_opt_n25(_uploadFile, _downloadFile, value) {
