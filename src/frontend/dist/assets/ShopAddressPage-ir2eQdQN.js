import { j as jsxRuntimeExports } from "./index-B_8bstpq.js";
import { c as createLucideIcon, L as Layout, M as MapPin, l as Store, B as Badge } from "./Layout-D2y_KZ98.js";
import { C as Card, a as CardContent } from "./card-Bf7P4gg-.js";
import { S as Skeleton } from "./skeleton-JkftrCUH.js";
import { u as useShopInfo } from "./useShopInfo-htxr-ews.js";
    ...
    !isLoading && shopInfo && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "shop-address.card", className: "space-y-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-border bg-card shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6 space-y-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 pb-4 border-b border-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-lg gradient-warm flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Store, { className: "w-5 h-5 text-primary-foreground" }) }),
